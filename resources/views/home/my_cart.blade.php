...
<nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
    ...
    <div id="gallary" class="text-center bg-dark text-light has-height-md middle-items wow fadeIn">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a onclick="return confirm('are you sure to remove this')" class="btb btn-danger" href="{{url('remove_cart',$data->id)}}">Remove</a>
                </td>
            </tr>
            <?php
        ...
        <h3>Total Price for the Cart Rs. {{$total_price}}</h3>
    </div>
    ...
    <div class="div_center">
        <form action="{{url('confirm_order')}}" method="post">
          ...
          <div class="div_deg">
            <input class="btn btn-info" type="submit" value="Conform Order">
          </div>
        </form>
    </div>
</body>
